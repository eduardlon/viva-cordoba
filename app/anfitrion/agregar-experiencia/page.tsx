...
export default function AgregarExperiencia() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert("Experiencia agregada (simulado)");
  };
  ...
  return (
    <div className="flex flex-col items-center min-h-screen relative bg-gray-100 p-6">
      <div className="w-full max-w-lg bg-white rounded-xl shadow-lg p-8 z-10 relative">
        ...
        <h1 className="text-2xl font-bold text-center mb-8 text-green-800">Agregar Experiencia</h1>
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label className="block text-green-800 font-semibold mb-2">Título de la experiencia</label>
            <input
              type="text"
              name="titulo"
              value={form.titulo}
              ...
              placeholder="Ej: Tour por el río Sinú"
            />
          </div>
          <div>
            <label className="block text-green-800 font-semibold mb-2">Ubicación</label>
            <input
              type="text"
              name="ubicacion"
          ...
          <div>
            <label className="block text-green-800 font-semibold mb-2">Precio por persona (COP)</label>
            <input
              type="number"
              name="precio"
              value={form.precio}
